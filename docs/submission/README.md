...
「동네 한의원 마케팅 AI」는 의료법 제56조·제27조를 아는 AI입니다. 위험한 문구를 붙이면 조항별로 짚고 고치고, 원장 말투의 프로필로 플레이스·블로그·인스타 글과 리뷰 답글을 규정에 맞게 씁니다. 첫 사용자는 2007년부터 한자리에서 진료 중인 한의원입니다. 한의원에서 시작해 1인 원장 동네 의원으로 확장합니다. 이 도구는 사전심의를 대체하지 않는 보조 도구입니다.
...
- **제품명:** 동네 한의원 마케팅 AI
- **한 줄:** 의료광고 규정을 아는 AI가 동네 한의원 홍보 글을 쓰고 검수합니다.
